...
pub fn disassembleInstruction(chunk: *Chunk, offset: usize) usize {
    ...
    return switch (@intToEnum(OpCode, instruction)) {
        ...
        .define_indexer_const => simpleInstruction("def indx const", offset),
        .define_indexer_const_pop => simpleInstruction("def indx const (pop)", offset),
        .define_indexer_var => simpleInstruction("def indx var", offset),
        .define_indexer_var_pop => simpleInstruction("def indx var (pop)", offset),
        ...
        .set => byteInstruction("set", chunk, offset),
    };
}
